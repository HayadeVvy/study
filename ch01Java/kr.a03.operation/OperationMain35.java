...
public class OperationMain35 {
	public static void main(String[] args) {
		/*
		 * [실습]
		 * 동전을 넣고 커피를 주문하면 커피를 판매하는
		 * 자판기 프로그램
		 * 자판기는 자판기 보유 동전(1000),커피(10),
		 * 프림(10),설탕(10)을 보유하고 있고 커피를
		 * 주문할 때 마다 자판기 보유 동전-거스름돈,
		 * 커피 5, 프림 3,설탕 1씩 차감되고 0이 되면
		 * 판매를 중단함.
		 * 
		 * [입력 및 출력 예시]
		...
		while(true) {
			...
			if(num==1) {//커피 마시기
				...
				System.out.printf(
						"자판기 보유 동전 금액:%,d%n", coin);
				System.out.printf(
						"투입한 동전 금액:%,d%n", amount);
				System.out.println("=".repeat(20));				
			}else if(num==2) {
				System.out.println("커피를 그만 마실래요~");
				break;
			}else {

...
<div class="page-main">
	...
	<ul>
		<li>
			...
			<img src="${pageContext.request.contextPath}/resources/images/face.png" width="100" height="100" class="my-photo">
			</c:if>
			<c:if test="${!empty member.photo_name}">
			<img src="photoView.do" width="100" height="100" class="my-photo">
			</c:if>
		</li>
		<li>

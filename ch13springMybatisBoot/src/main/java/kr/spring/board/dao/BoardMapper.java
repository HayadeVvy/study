...
public interface BoardMapper {
	@Insert("INSERT INTO aboard (num,writer,title,passwd,"
		  + "content,reg_date) VALUES (aboard_seq.nextval,"
		  + "#{writer},#{title},#{passwd},#{content},SYSDATE)")
	...
	@Update("UPDATE aboard SET writer=#{writer},"

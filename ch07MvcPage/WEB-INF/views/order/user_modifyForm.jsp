...
$(function(){
	...
	$('#order_modify').submit(function(event){
		let isValid = true;
		//모든 에러 텍스트 초기화
		$('.error-text').text('');
...
<div class="page-main">
	...
	<div class="content-main">
		...
		<div class="result-display">
			배송대기일 때만 배송지를 수정할 수 있습니다.
		</div>
		</c:if>
		<c:if test="${order.status == 1}">
		<form id="order_modify" action="orderModify.do"
		                               method="post">
			...
			<ul>
				<li>
					...
					<input type="text" name="receive_name" 
					  id="receive_name" value="${order.receive_name}"
				...
				<li>
					...
					<input type="text" name="receive_phone" 
					  id="receive_phone" value="${order.receive_phone}"
				...
				<li>
					...
					<input type="text" name="receive_post" 
					  id="zipcode" value="${order.receive_post}"
				...
				<li>
					...
					<input type="text" name="receive_address1" 
					  id="address1" value="${order.receive_address1}"
				...
				<li>
					...
					<input type="text" name="receive_address2" 
					  id="address2" value="${order.receive_address2}"
					  maxlength="30" class="form-input">
					<span class="error-text"></span>
				</li>
				<li>
    ...
    function execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                //주소 안내 메시지 초기화
                document.getElementById('zipcode').dispatchEvent(new Event('input'));
                document.getElementById('address1').dispatchEvent(new Event('input'));

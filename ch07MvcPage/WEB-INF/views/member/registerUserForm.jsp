...
$(function(){
	...
	$('#register_form').submit(function(event){
		...
		$('.input-check').each(function(index,item){
			if($(item).val().trim()==''){
				$('#msg_' + $(item).attr('id')).css('color','red')
				                               .text('필수 입력');
				//반복은 처리하고 submit를 되지 않도록 처리
				isValid = false;
			}

...
public class ChatRoomListAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		//타이틀 HTML 태그 불허
		vo.setTitle(StringUtil.useBrNoHtml(vo.getTitle()));
		
		int count = dao.getChatCount(
				         keyfield, keyword, board_num);
		...
		if(count > 0)System.out.println("채팅 개수 체크 => count : " + count + ", list : " + list.size());
